...
[![arXiv](https://img.shields.io/badge/arXiv-2511.21331-b31b1b.svg)](https://arxiv.org/abs/2511.21331)
[![Project Page](https://img.shields.io/badge/Project%20Page-Online-blue)](https://estafons.github.io/confu/)
[![GitHub Code](https://img.shields.io/badge/Code-Repository-black)](https://github.com/estafons/confu)
[![Dataset](https://img.shields.io/badge/Dataset-Download-green)](https://zenodo.org/records/18920487)
...
# Example Code - Illustration of the Method

Below is a minimal implementation of the **ConFu architecture**.  
To adapt it to your own multimodal setting, simply provide the appropriate **encoder** and **fusion modules** when instantiating the class.

Encoders can be any `nn.Module` that produces a feature representation for a modality, and fusion modules can be any module that combines two modality embeddings into a joint representation.
...
3. **Download the training data and **train the model** yourself.
...
@article{koutoupis2025more,
  ...
  author={Koutoupis, Stefanos and Zervou, Michaela Areti and Kontras, Konstantinos and De Vos, Maarten and Tsakalides, Panagiotis and Tsagkatakis, Grigorios},
